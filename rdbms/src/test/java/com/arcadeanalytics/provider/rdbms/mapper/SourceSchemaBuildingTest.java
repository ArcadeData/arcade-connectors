...
public class SourceSchemaBuildingTest {
    ...
    public void buildSourceSchemaFromTwoTablesWithOneSimplePK() {
    ...
    public void buildSourceSchemaFromThreeTablesWithOneCompositePK() {
    ...
    public void buildSourceSchemaFromThreeTablesWithOneSimplePKImportedTwice() {
        ...
        try {
            ...
            assertEquals(2, statistics.totalNumberOfEntities);
            assertEquals(2, statistics.builtEntities);
            assertEquals(2, statistics.totalNumberOfRelationships);
            assertEquals(2, statistics.builtRelationships);
    ...
    public void buildSourceSchemaFromThreeTablesWithOneCompositePKImportedTwice() {
    ...
    public void buildSourceSchemaFromJoinTableAnd2ParentTables() {
