...
public class DataBaseSchema implements DataSourceSchemaInfo {
    ...
    public DataBaseSchema(int majorVersion, int minorVersion, int driverMajorVersion, int driverMinorVersion, String productName,
    ...
    public Entity getEntityByPosition(int position) {
        for (Entity currentEntity : this.entities) {
            if (currentEntity.getSchemaPosition() == position)
                return currentEntity;
        }
    ...
    public Relationship getRelationshipByInvolvedEntitiesAndAttributes(Entity currentForeignEntity, Entity currentParentEntity,
