...
/**
 * Implementation of PluginMessageHandler for Arcade Analytics plugin. It receives messages
 * application from the application and just delegates its printing on a stream through the
 * OutputStreamManager.
 *
