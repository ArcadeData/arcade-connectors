...
public class ModelProperty {
    ...
    public ModelProperty(String name, int ordinalPosition, String originalType, boolean fromPrimaryKey,
    ...
    public ModelProperty(String name, int ordinalPosition, String originalType, String orientdbType, boolean fromPrimaryKey,
                         ElementType belongingElementType, boolean mandatory, boolean readOnly, boolean notNull) {
        this.name = name;
        this.ordinalPosition = ordinalPosition;
        this.originalType = originalType;
