...
public class Hibernate2GraphMapper extends ER2GraphMapper {
    ...
    public Hibernate2GraphMapper(DataSourceInfo dataSource,
                                 String xmlPath,
    ...
    // Table per Class Hierarchy or Table per Subclass Inheritance
    private void performSubclassTagInheritance(HierarchicalBag hierarchicalBag, Entity parentEntity, NodeList subclassElements,
        ...
        // Table per Class Hierarchy
            ...
            for (int i = 0; i < subclassElements.getLength(); i++) {
                ...
                for (int j = 0; j < propertiesElements.getLength(); j++) {
                    ...
                    currentChildAttribute = new Attribute(currentParentCorrespondingAttribute.getName(), j + 1,
    ...
    // Table per Subclass Inheritance
    private void performJoinedSubclassTagInheritance(HierarchicalBag hierarchicalBag, Entity parentEntity,
