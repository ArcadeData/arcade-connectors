...
public class CanonicalRelationship extends Relationship {
  ...
  public CanonicalRelationship(
      Entity foreignEntity, Entity parentEntity, ForeignKey foreignKey, PrimaryKey primaryKey) {
    this.foreignEntity = foreignEntity;
    this.parentEntity = parentEntity;
  ...
  public String toString() {
    return ("CanonicalRelationship [foreignEntity="
