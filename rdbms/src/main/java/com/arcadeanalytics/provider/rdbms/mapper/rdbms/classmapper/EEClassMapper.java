...
/**
 * This class is responsible to map 2 classes of objects: Entity and EdgeType. the following values
 * are mapped: - name of the entity -&gt; name of the edge type - each attribute of the entity -&gt;
