...
public class EdgeType extends ElementType {
    ...
    public EdgeType(String edgeType, VertexType outVertexType, VertexType inVertexType, int numberRelationshipsRepresented,
                    boolean isSplittingEdge, boolean isAggregatorEdge) {
        super(edgeType);
        this.outVertexType = outVertexType;
        this.inVertexType = inVertexType;
