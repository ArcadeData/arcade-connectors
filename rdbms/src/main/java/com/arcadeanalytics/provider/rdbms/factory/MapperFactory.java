...
public class MapperFactory {
    ...
    public ER2GraphMapper buildMapper(String chosenMapper,
        ...
        switch (chosenMapper) {
            ...
            case "hibernate":
                return new Hibernate2GraphMapper(dataSource, xmlPath, includedTables, excludedTables, queryEngine, handler, executionStrategy, nameResolver, statistics);
