...
/**
 * This class is responsible to map 2 classes of objects: Entity and VertexType. the following
 * values are mapped: - name of the entity -&gt; name of the vertex type - each attribute of the
 * entity -&gt; correspondent property of the vertex type - each property of the vertex type -&gt;
 * correspondent attribute of the entity
 *
